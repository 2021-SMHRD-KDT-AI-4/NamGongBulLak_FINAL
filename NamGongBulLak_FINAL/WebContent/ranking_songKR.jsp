        ...
        <div style="height: 51rem; margin: 0 7rem; display: flex; flex-direction: row;">
            ...
            <div style="width: 38.25rem;">
                <div style="height: 17.5rem;">
                    <div style="height: 100%; display: flex; flex-direction: row; font-size: 1.2rem">
	...
	console.log(songs);
	   song.addEventListener('click', function(event) {
	      for (var i = 0; i < songs.length; i++) {
	    	  songs[i].style.backgroundColor = "rgba(207, 207, 207, 0)";
	      }
	      song.style.backgroundColor = "rgba(112, 112, 112, 0.7)";
	   });
};
