...
<head>
    ...
    <script type="text/javascript">   
        ...
        $(document).ready(function() {
			$("#payment").load("./paymentEN.jsp");
		});
        sessionStorage.clear();
        sessionStorage.setItem("store", "storeEN");
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr 1fr;">
                ...
                <div style="width: 12.5rem; height: 15rem; border: 0.0625rem solid white; border-radius: 1rem; margin-bottom: 2.5rem;">
                    ...
                    <div class='product' style="width: 12.5rem; height: 12.5rem; border-bottom: 0.0625rem solid white; background-color: rgba(255,255,255,0.7); border-top-left-radius: 1rem; border-top-right-radius: 1rem;">
                        ...
                        <!-- 상품 이름 -->
                        <span style="font-size: 1.2rem; color: black;" id="prpr" value="premium">PREMIUM USER</span>
                    </div>
                    <!-- 상품 hover 시 -->
                    ...
                    <div style="height: 2.5rem; background-color: black; border-bottom-left-radius: 1rem; border-bottom-right-radius: 1rem; border-bottom: 0.0625rem solid white;">
                        ...
                        <!-- 상품 가격 -->
                        <span style="font-size: 1.2rem;" id="prprice" value="7000">7000won/month</span>
                    </div>
                </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr 1fr;">
                ...
                <div style="width: 12.5rem; height: 15rem; border: 0.0625rem solid white; border-radius: 1rem; margin-bottom: 2.5rem;">
                    ...
                    <div class='product' style="width: 12.5rem; height: 12.5rem; border-bottom: 0.0625rem solid white; background-color: rgba(255,255,255,0.7); border-top-left-radius: 1rem; border-top-right-radius: 1rem;">
                        ...
                        <!-- 상품 이름 -->
                        <span style="font-size: 1.2rem; color: black;" id="spr55" value="spr5">Song voucher(5p)</span>
                    </div>
                    <!-- 상품 hover 시 -->
                    <div class="hoverProduct" style="height: 12.5rem; border-bottom: 0.0625rem solid white; background-color: rgba(255,255,255,0.5); border-top-left-radius: 1rem; border-top-right-radius: 1rem;">
                        <div style="height: 5.5rem;"></div>
                    ...
                    <div style="height: 2.5rem; background-color: black; border-bottom-left-radius: 1rem; border-bottom-right-radius: 1rem; border-bottom: 0.0625rem solid white;">
                        <div style="height: 0.5rem;"></div>
                        <!-- 상품 가격 -->
                        <span style="font-size: 1.2rem;" id="spr5price" value="4800">4,800won</span>
                    </div>
                </div>
                ...
                <div style="width: 12.5rem; height: 15rem; border: 0.0625rem solid white; border-radius: 1rem; margin-bottom: 2.5rem;">
                    ...
                    <div class='product' style="width: 12.5rem; height: 12.5rem; border-bottom: 0.0625rem solid white; background-color: rgba(255,255,255,0.7); border-top-left-radius: 1rem; border-top-right-radius: 1rem;">
                        ...
                        <!-- 상품 이름 -->
                        <span style="font-size: 1.2rem; color: black;" id="spr5" value="spr5">Song voucher(3p)</span>
                    </div>
                    <!-- 상품 hover 시 -->
                    <div class="hoverProduct" style="height: 12.5rem; border-bottom: 0.0625rem solid white; background-color: rgba(255,255,255,0.5); border-top-left-radius: 1rem; border-top-right-radius: 1rem;">
                        <div style="height: 5.5rem;"></div>
                    ...
                    <div style="height: 2.5rem; background-color: black; border-bottom-left-radius: 1rem; border-bottom-right-radius: 1rem; border-bottom: 0.0625rem solid white;">
                        <div style="height: 0.5rem;"></div>
                        <!-- 상품 가격 -->
                        <span style="font-size: 1.2rem;" id="spr5price" value="2900">2,900won</span>
                    </div>
                </div>
                ...
                <div style="width: 12.5rem; height: 15rem; border: 0.0625rem solid white; border-radius: 1rem; margin-bottom: 2.5rem;">
                    ...
                    <div class='product' style="width: 12.5rem; height: 12.5rem; border-bottom: 0.0625rem solid white; background-color: rgba(255,255,255,0.7); border-top-left-radius: 1rem; border-top-right-radius: 1rem;">
                        ...
                        <!-- 상품 이름 -->
                        <span style="font-size: 1.2rem; color: black;" id="spr1" value="spr1">Song voucher(1p)</span>
                    </div>
                    <!-- 상품 hover 시 -->
                    <div class="hoverProduct" style="height: 12.5rem; border-bottom: 0.0625rem solid white; background-color: rgba(255,255,255,0.5); border-top-left-radius: 1rem; border-top-right-radius: 1rem;">
                        <div style="height: 5.5rem;"></div>
                    ...
                    <div style="height: 2.5rem; background-color: black; border-bottom-left-radius: 1rem; border-bottom-right-radius: 1rem; border-bottom: 0.0625rem solid white;">
                        <div style="height: 0.5rem;"></div>
                        <!-- 상품 가격 -->
                        <span style="font-size: 1.2rem;" id="spr1price" value="1000">1,000won</span>
                    </div>
                </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr 1fr;">
                ...
                <div style="width: 12.5rem; height: 15rem; border: 0.0625rem solid white; border-radius: 1rem; margin-bottom: 2.5rem;">
                    ...
                    <div style="height: 2.5rem; background-color: black; border-bottom-left-radius: 1rem; border-bottom-right-radius: 1rem; border-bottom: 0.0625rem solid white;">
                        <div style="height: 0.5rem;"></div>
                        <!-- 상품 가격 -->
                        <span style="font-size: 1.2rem;" id="vf1price" value="1000">1,000won</span>
                    </div>
                </div>
                ...
                <div style="width: 12.5rem; height: 15rem; border: 0.0625rem solid white; border-radius: 1rem; margin-bottom: 2.5rem;">
                    ...
                    <div style="height: 2.5rem; background-color: black; border-bottom-left-radius: 1rem; border-bottom-right-radius: 1rem; border-bottom: 0.0625rem solid white;">
                        <div style="height: 0.5rem;"></div>
                        <!-- 상품 가격 -->
                        <span style="font-size: 1.2rem;" id="vf2price" value="1000">1,000won</span>
                    </div>
                </div>
                ...
                <div style="width: 12.5rem; height: 15rem; border: 0.0625rem solid white; border-radius: 1rem; margin-bottom: 2.5rem;">
                    ...
                    <div style="height: 2.5rem; background-color: black; border-bottom-left-radius: 1rem; border-bottom-right-radius: 1rem; border-bottom: 0.0625rem solid white;">
                        <div style="height: 0.5rem;"></div>
                        <!-- 상품 가격 -->
                        <span style="font-size: 1.2rem;" id="vf3price" value="1000">1,000won</span>
                    </div>
                </div>
                ...
                <div style="width: 12.5rem; height: 15rem; border: 0.0625rem solid white; border-radius: 1rem; margin-bottom: 2.5rem;">
                    ...
                    <div style="height: 2.5rem; background-color: black; border-bottom-left-radius: 1rem; border-bottom-right-radius: 1rem; border-bottom: 0.0625rem solid white;">
                        <div style="height: 0.5rem;"></div>
                        <!-- 상품 가격 -->
                        <span style="font-size: 1.2rem;" id="vf=4price" value="1000">1,000won</span>
                    </div>
                </div>
                ...
                <div style="width: 12.5rem; height: 15rem; border: 0.0625rem solid white; border-radius: 1rem; margin-bottom: 2.5rem;">
                    ...
                    <div style="height: 2.5rem; background-color: black; border-bottom-left-radius: 1rem; border-bottom-right-radius: 1rem; border-bottom: 0.0625rem solid white;">
                        <div style="height: 0.5rem;"></div>
                        <!-- 상품 가격 -->
                        <span style="font-size: 1.2rem;" id="vf5price" value="1000">1,000won</span>
                    </div>
                </div>
                ...
                <div style="width: 12.5rem; height: 15rem; border: 0.0625rem solid white; border-radius: 1rem; margin-bottom: 2.5rem;">
                    ...
                    <div style="height: 2.5rem; background-color: black; border-bottom-left-radius: 1rem; border-bottom-right-radius: 1rem; border-bottom: 0.0625rem solid white;">
                        <div style="height: 0.5rem;"></div>
                        <!-- 상품 가격 -->
                        <span style="font-size: 1.2rem;" id="vf6price" value="1000">1,000won</span>
                    </div>
                </div>
                ...
                <div style="width: 12.5rem; height: 15rem; border: 0.0625rem solid white; border-radius: 1rem; margin-bottom: 2.5rem;">
                    ...
                    <div style="height: 2.5rem; background-color: black; border-bottom-left-radius: 1rem; border-bottom-right-radius: 1rem; border-bottom: 0.0625rem solid white;">
                        <div style="height: 0.5rem;"></div>
                        <!-- 상품 가격 -->
                        <span style="font-size: 1.2rem;" id="vf7price" value="1000">1,000won</span>
                    </div>
                </div>
                ...
                <div style="width: 12.5rem; height: 15rem; border: 0.0625rem solid white; border-radius: 1rem; margin-bottom: 2.5rem;">
                    ...
                    <div style="height: 2.5rem; background-color: black; border-bottom-left-radius: 1rem; border-bottom-right-radius: 1rem; border-bottom: 0.0625rem solid white;">
                        <div style="height: 0.5rem;"></div>
                        <!-- 상품 가격 -->
                        <span style="font-size: 1.2rem;" id="vf8price" value="1000">1,000won</span>
                    </div>
                </div>
                ...
                <div style="width: 12.5rem; height: 15rem; border: 0.0625rem solid white; border-radius: 1rem; margin-bottom: 2.5rem;">
                    ...
                    <div style="height: 2.5rem; background-color: black; border-bottom-left-radius: 1rem; border-bottom-right-radius: 1rem; border-bottom: 0.0625rem solid white;">
                        <div style="height: 0.5rem;"></div>
                        <!-- 상품 가격 -->
                        <span style="font-size: 1.2rem;" id="vf9price" value="1000">1,000won</span>
                    </div>
                </div>
                ...
                <div style="width: 12.5rem; height: 15rem; border: 0.0625rem solid white; border-radius: 1rem; margin-bottom: 2.5rem;">
                    ...
                    <div style="height: 2.5rem; background-color: black; border-bottom-left-radius: 1rem; border-bottom-right-radius: 1rem; border-bottom: 0.0625rem solid white;">
                        <div style="height: 0.5rem;"></div>
                        <!-- 상품 가격 -->
                        <span style="font-size: 1.2rem;" id="vf10price" value="1000">1,000won</span>
                    </div>
                </div>
            </div>
        </div>
